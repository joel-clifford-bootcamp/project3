    ...
    <div className="col s12 m12 ccenter-align">
      ...
      <div className="col s12 m4 ccenter-align">
        ...
        >
              ...
              <img className="responsive-img userImage" src="http://via.placeholder.com/150x150" width="100" height="100" alt="user_card_image"/>
            </div>
        ...
        <div className="col mb-6 sm-12">
          ...
          >
            ...
            <div className="card-image" style={{ margin: "10px" }}>
              ...
              <img className="responsive-img activityImage" src="http://via.placeholder.com/100x100" width="100" height="100" alt="activity_card_image"/>
            </div>
            <div
              className="card-content"
              style={{ padding: "10px", margin: "10px" }}
